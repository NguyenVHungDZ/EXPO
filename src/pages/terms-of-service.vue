...
const { t } = useI18n() // Multiple languages
definePageMeta({ layout: 'page' })
useHead({ titleTemplate: '', title: t('register.terms') })
const max = ref(0) // Maximum scrollable height
const value = ref(0) // Track current scroll position
const innerRef = ref<HTMLDivElement>() // Scrollable content
const scrollbarRef = ref<InstanceType<typeof ElScrollbar>>() // Reference to ElScrollbar component

// Control how deeply can user scroll
onMounted(() => {
  max.value = innerRef.value!.clientHeight - 380
})

// Function to update the scroll position via a slider
// Set the scroll position of the ElScrollbar component
const inputSlider = (value: number) => {
  scrollbarRef.value?.setScrollTop(value) // Scroll to 'value' position
}

// Update vlue to scrollTop position
const scroll = ({ scrollTop }: { scrollTop: number }) => {
  value.value = scrollTop
}

// Return current return position in px, used to show on the slide bar
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                of the Service. This Terms of Service Agreement was generated by
                <a
